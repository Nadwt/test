...
<body style="overflow-y: hidden">
         ...
         <div id="fontzoom">
             ...
             <div style="position:absolute; z-index:100; left:1400px; top:200px;font-size:110px">飞鹰班组今日执勤实力</div>
                     ...
                     jQuery.ajax({
                         ...
                         success: function (msg) {
                             ...
                             document.getElementById("d5").onclick = function () {
                                 window.open("file:///C:/Users/Administrator/Desktop/zhibanyemian/航站楼一楼.html");
                             };
                             if (val < 0.13) {
                     ...
                     jQuery.ajax({
                         ...
                         success: function (msg) {
                             ...
                             document.getElementById("d8").onclick = function () {
                                 window.open("file:///C:/Users/Administrator/Desktop/zhibanyemian/航站楼二楼.html");
                             };
                             if (val < 0.13) {
